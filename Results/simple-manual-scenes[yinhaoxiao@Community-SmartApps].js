                            ...
                            if (dev) {
                                ...
                                if (settings["$deviceIDState"] == 'off') {
                                    ...
                                    if (settings["$deviceIDHue"]) {
                                        huenum = this.rangeFix(settings["$deviceIDHue"])
                                        dev.setHue(huenum)
                                    }
                                    if (settings["$deviceIDSaturation"]) {
                                        dev.setSaturation(this.rangeFix(settings["$deviceIDSaturation"]))
                                    }
                                    if (settings["$deviceIDColorTemperature"]) {
                                        dev.setColorTemperature(settings["$deviceIDColorTemperature"])
                                    }
                                }
                            }
                        })
