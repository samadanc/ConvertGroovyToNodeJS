...
module.exports = new SmartApp()
    ...
    .updated(async (context, updateData) => {
        ...
        await context.api.subscriptions.subscribeToDevices(context.config.thermostats, 'thermostat', 'climateName', 'changeFanMinOnTime')

        await context.api.subscriptions.subscribeToDevices(context.config.thermostats, 'thermostat', 'setClimate', 'changeFanMinOnTime')
