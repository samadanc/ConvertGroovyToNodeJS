...
module.exports = new SmartApp()
    ...
    .page('mainPage', (context, page, configData) => {
        ...
        page.section('Temperature settings:', section => {
            ...
            section.booleanSetting('userOverride').name('Override smartapp control?');
    ...
    .subscribedEventHandler('myHandler', (context, event) => {
        ...
        if (state.runtime) {
        if (Inside > MinimumTemp && Inside > Outside + Delta && !state.fanRunning) {
        console.log('Turn on')
        ...
        if (Inside < MinimumTemp || Inside < Outside && state.fanRunning) {
