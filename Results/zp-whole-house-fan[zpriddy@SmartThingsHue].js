...
module.exports = new SmartApp()
    ...
    .updated(async (context, updateData) => {
        ...
        await context.api.subscriptions.subscribeToDevices(context.config.thermostat, 'thermostat', 'thermostatMode', 'checkContacts')
    ...
    .subscribedEventHandler('checkThings', (context, event) => {
        ...
        console.log("Inside Temp: $insideTemp Outside Temp: $outsideTemp Min Temp: ${settings.minTemp} FanIsRunning: ${state.fanRunning}")
