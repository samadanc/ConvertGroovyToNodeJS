...
module.exports = new SmartApp()
    ...
    .scheduledEventHandler('initialize', (context, event) => {
        ...
        log.info("$thermostats Scheduled next adjustment for ${this.timeToday(time2, location.timeZone).format(EEE MMM dd yyyy HH:mm z, location.timeZone)}")
        } else {
        ...
        log.info("$thermostats Scheduled next adjustment for ${this.timeToday(time3, location.timeZone).format(EEE MMM dd yyyy HH:mm z, location.timeZone)}")
        } else {
        ...
        log.info("$thermostats Scheduled next adjustment for ${this.timeToday(time4, location.timeZone).format(EEE MMM dd yyyy HH:mm z, location.timeZone)}")
        } else {
        ...
        log.info("$thermostats Scheduled next adjustment for ${(this.timeToday(time1, location.timeZone) + 1).format(EEE MMM dd yyyy HH:mm z, location.timeZone)}")
        } else {
        ...
        log.info("$thermostats Scheduled next adjustment for ${this.timeToday(time1, location.timeZone).format(EEE MMM dd yyyy HH:mm z, location.timeZone)}")
        }
        }
        }
        }
        ...
        log.info("$thermostats Scheduled next adjustment for ${(this.timeToday(time11, location.timeZone) + 1).format(EEE MMM dd yyyy HH:mm z, location.timeZone)}")
        } else {
        ...
        log.info("$thermostats Scheduled next adjustment for ${this.timeToday(time11, location.timeZone).format(EEE MMM dd yyyy HH:mm z, location.timeZone)}")
        }
        }
        }
        }
        ...
        log.info("$thermostats Scheduled next adjustment for ${this.timeToday(time21, location.timeZone).format(EEE MMM dd yyyy HH:mm z, location.timeZone)}")
        } else {
        ...
        log.info("$thermostats Scheduled next adjustment for ${this.timeToday(time31, location.timeZone).format(EEE MMM dd yyyy HH:mm z, location.timeZone)}")
        } else {
        ...
        log.info("$thermostats Scheduled next adjustment for ${this.timeToday(time41, location.timeZone).format(EEE MMM dd yyyy HH:mm z, location.timeZone)}")
        } else {
