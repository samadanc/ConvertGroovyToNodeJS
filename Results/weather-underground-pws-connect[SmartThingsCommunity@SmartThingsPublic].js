...
module.exports = new SmartApp()
    ...
    .updated(async (context, updateData) => {
        ...
        context.api.schedules.runEvery5Minutes('updateCurrentWeather', delay);
