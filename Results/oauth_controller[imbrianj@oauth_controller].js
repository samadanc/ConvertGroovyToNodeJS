...
module.exports = new SmartApp()
    ...
    .page('mainPage', (context, page, configData) => {
        ...
        page.section('Allow Endpoint to Control These Things...', section => {
            ...
            section.deviceSetting('temp').capability(['temperatureMeasurement']).name('Which Temp?');
            section.deviceSetting('vibrate').capability(['accelerationSensor']).name('Which Vibrate?');
