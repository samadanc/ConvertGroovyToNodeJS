...
module.exports = new SmartApp()
    ...
    .page('mainPage', (context, page, configData) => {
        ...
        page.section('Locks to Log', section => {
            ...
            section.enumSetting('lockLogType').name('Value to log');
        ...
        page.section('mySql Logger php location', section => {
        ...
        page.section('Technical settings', section => {
            section.enumSetting('queueTime').name('Time to queue events before pushing to databas (in minutes)');
