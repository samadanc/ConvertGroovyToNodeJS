...
module.exports = new SmartApp()
    ...
    .page('mainPage', (context, page, configData) => {
        ...
        page.section('Control these LED strips', section => {
            section.enumSetting('color').name('What color?');
            section.enumSetting('brightness').name('How bright?');
    ...
    .subscribedEventHandler('illuminanceHandler', (context, event) => {
        ...
        context.api.devices.sendCommands(context.config.Ledstrip, 'device.SmartRoomController', off)
