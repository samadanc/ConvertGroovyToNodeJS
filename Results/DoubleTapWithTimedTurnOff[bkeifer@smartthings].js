...
module.exports = new SmartApp()
    ...
    .page('mainPage', (context, page, configData) => {
        ...
        page.section('Turn off delay', section => {
            section.numberSetting('delay').name('');
    ...
    .subscribedEventHandler('switchHandler', (context, event) => {
        ...
        this.onSwitches()*.on()
        console.log("Will turn off in $delay minutes.")
        this.runIn(delay * 60, 'timerOff', ['overwrite': false])
        } else {
