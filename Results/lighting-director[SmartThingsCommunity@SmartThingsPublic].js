...
module.exports = new SmartApp()
    ...
    .subscribedEventHandler('onEventD', (context, event) => {
        ...
        if (this.getInputOk(D_motion, D_contact, D_lock, D_acceleration)) {
    ...
    .subscribedEventHandler('onEventB', (context, event) => {
        ...
        if (this.getInputOk(B_motion, B_contact, B_lock, B_acceleration)) {
    ...
    .subscribedEventHandler('onEventC', (context, event) => {
        ...
        if (this.getInputOk(C_motion, C_contact, C_lock, C_acceleration)) {
