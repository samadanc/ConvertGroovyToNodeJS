...
module.exports = new SmartApp()
    ...
    .page('mainPage', (context, page, configData) => {
        ...
        page.section('Choose one or more, when...', section => {
            ...
            section.deviceSetting('valve').capability(['valve']).name('Valve Opens');
            section.deviceSetting('valveClosed').capability(['valve']).name('Valve Closes');
            section.deviceSetting('powerSources').capability(['powerSource']).name('Power Source Changes');
