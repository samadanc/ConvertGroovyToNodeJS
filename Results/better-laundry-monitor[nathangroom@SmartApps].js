...
module.exports = new SmartApp()
    ...
    .page('mainPage', (context, page, configData) => {
        ...
        page.section('Notification method', section => {
            ...
            section.deviceSetting('speechOut').capability(['speechSynthesis']).name('Speak Via: (Speech Synthesis)');
            section.deviceSetting('player').capability(['musicPlayer']).name('Speak Via: (Music Player -> TTS)');
