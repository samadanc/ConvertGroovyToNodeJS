...
module.exports = new SmartApp()
    ...
    .page('mainPage', (context, page, configData) => {
        ...
        page.section('', section => {
            ...
            section.deviceSetting('buttonGroup').capability(['button']).name('Buttons');
            ...
            section.deviceSetting('speechSyntheses').capability(['speechSynthesis']).name('Speech Syntheses');
            ...
            section.deviceSetting('tones').capability(['tone']).name('Tones');
