...
module.exports = new SmartApp()
    ...
    .subscribedEventHandler('switchOffHandler', (context, event) => {
        ...
        this.runIn(i, updateVirtualSwitch)
        }
    ...
    .subscribedEventHandler('virtualSwitchHandler', (context, event) => {
        ...
        if (this.now() - httpswitch*.currentValue('customTriggeredEPOCH')[0] > 3000) {
        
        context.api.devices.sendCommands(context.config.httpswitch, 'switch', off)
