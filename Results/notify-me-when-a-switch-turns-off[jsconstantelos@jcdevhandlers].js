...
module.exports = new SmartApp()
    ...
    .updated(async (context, updateData) => {
        ...
        await context.api.subscriptions.subscribeToDevices(context.config.switches1, 'switch', 'switch.off', 'switchOffHandler')
    ...
    .subscribedEventHandler('switchOffHandler', (context, event) => {
        ...
        if (lastSwitch) {
        if (lastSwitch == 'off') {
        this.sendSms(phone1, "Your ${it.displayName} was turned OFF!")
        }
        }
        }
        catch (let e) {
