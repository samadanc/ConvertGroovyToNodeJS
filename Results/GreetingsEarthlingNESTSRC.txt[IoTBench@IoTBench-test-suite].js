...
module.exports = new SmartApp()
    ...
    .page('mainPage', (context, page, configData) => {
        ...
        page.section('Set this NEST to PRESENT', section => {
            section.deviceSetting('Nest').capability(['thermostat']).name('');

        });


        page.section('Flash notifications with an LED strip', section => {
    ...
    .subscribedEventHandler('presence', (context, event) => {
        ...
        console.log('Setting NEST to PRESENT')
        
        context.api.devices.sendCommands(context.config.Nest, 'thermostat', present)
