...
module.exports = new SmartApp()
    ...
    .page('mainPage', (context, page, configData) => {
        ...
        page.section('Control these lights', section => {
            ...
            section.deviceSetting('bulbs2').capability(['switchLevel']).name('Hue light bulbs2');
            section.deviceSetting('bulbs3').capability(['switch']).name('Hue light bulbs3');
    ...
    .subscribedEventHandler('buttonHandler', (context, event) => {
        ...
        context.api.devices.sendCommands(context.config.bulbs2, 'switchLevel', setLevel)
