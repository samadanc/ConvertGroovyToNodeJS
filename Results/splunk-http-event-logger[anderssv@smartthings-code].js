...
module.exports = new SmartApp()
    ...
    .page('mainPage', (context, page, configData) => {
        ...
        page.section('Splunk Server', section => {
            section.textSetting('splunk_host').name('Splunk Hostname/IP');
            section.numberSetting('splunk_port').name('Splunk Port');
            section.textSetting('splunk_token').name('Splunk Authentication Token');
