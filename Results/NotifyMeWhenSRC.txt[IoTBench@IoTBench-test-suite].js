...
module.exports = new SmartApp()
    ...
    .page('mainPage', (context, page, configData) => {
        ...
        page.section('Send notifications and/or messages?', section => {
            section.enumSetting('notifications').name('Send a message/push notification?');
        ...
        page.section('Issue notifications with a Smart Room Controller', section => {
            ...
            section.enumSetting('audible').name('What (optional) sound?');
