...
module.exports = new SmartApp()
    ...
    .page('mainPage', (context, page, configData) => {
        ...
        page.section('And these will follow with color temperature...', section => {
            section.deviceSetting('slaves3').capability(['colorTemperature']).name('Slave Tunable White Bulbs...');
    ...
    .updated(async (context, updateData) => {
        ...
        await context.api.subscriptions.subscribeToDevices(context.config.masters, 'switchLevel', 'colorTemperature', 'switchSetColorTempHandler')
