...
module.exports = new SmartApp()
    ...
    .scheduledEventHandler('updateCurrentWeather', (context, event) => {
        ...
        let params = ['uri': 'http://weatherstation.wunderground.com', 'path': '/weatherstation/updateweatherstation.php', 'query': ['ID': weatherID , 'PASSWORD': password , 'dateutc': 'now', 'tempf': temp.currentTemperature * 1.8 + 32, 'humidity': humidity.currentHumidity, 'action': 'updateraw']]
