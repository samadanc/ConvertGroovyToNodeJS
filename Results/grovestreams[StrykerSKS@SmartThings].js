...
module.exports = new SmartApp()
    ...
    .updated(async (context, updateData) => {
        ...
        await context.api.subscriptions.subscribeToDevices(context.config.automatic, 'device.myAutomaticDevice', 'yesterdayAvgTripDistance', 'handleDailyStats')
        ...
        await context.api.subscriptions.subscribeToDevices(context.config.automatic, 'device.myAutomaticDevice', 'yesterdayTotalHardBrake', 'handleDailyStats')
        ...
        await context.api.subscriptions.subscribeToDevices(context.config.automatic, 'device.myAutomaticDevice', 'yesterdayAvgScoreEvents', 'handleDailyStats')
        ...
        await context.api.subscriptions.subscribeToDevices(context.config.automatic, 'device.myAutomaticDevice', 'yesterdayTotalHardAcceleration', 'handleDailyStats')
        ...
        await context.api.subscriptions.subscribeToDevices(context.config.automatic, 'device.myAutomaticDevice', 'yesterdayAvgTripDuration', 'handleDailyStats')
        ...
        await context.api.subscriptions.subscribeToDevices(context.config.automatic, 'device.myAutomaticDevice', 'yesterdayTotalNbTrip', 'handleDailyStats')

        await context.api.subscriptions.subscribeToDevices(context.config.location, 'location', 'mode', 'rescheduleIfNeeded')

        await context.api.subscriptions.subscribeToDevices(context.config.automatic, 'device.myAutomaticDevice', 'yesterdayTotalFuelVolume', 'handleDailyStats')

        await context.api.subscriptions.subscribeToDevices(context.config.automatic, 'device.myAutomaticDevice', 'yesterdayAvgScoreSpeeding', 'handleDailyStats')
        ...
        await context.api.subscriptions.subscribeToDevices(context.config.illuminances, 'illuminanceMeasurement', 'illuminanceMeasurement', 'handleIlluminanceEvent')

        await context.api.subscriptions.subscribeToDevices(context.config.automatic, 'device.myAutomaticDevice', 'yesterdayAvgTripConsumption', 'handleDailyStats')

        await context.api.subscriptions.subscribeToDevices(context.config.presence, 'presenceSensor', 'presence', 'handlePresenceEvent')

        await context.api.subscriptions.subscribeToDevices(context.config.automatic, 'device.myAutomaticDevice', 'yesterdayTotalDuration', 'handleDailyStats')
        ...
        await context.api.subscriptions.subscribeToDevices(context.config.automatic, 'device.myAutomaticDevice', 'yesterdayAvgTripFuelVolume', 'handleDailyStats')

        await context.api.subscriptions.subscribeToDevices(context.config.automatic, 'device.myAutomaticDevice', 'yesterdayTotalDistance', 'handleDailyStats')
        ...
        await context.api.subscriptions.subscribeToDevices(context.config.humidities, 'relativeHumidityMeasurement', 'relativeHumidityMeasurement', 'handleHumidityEvent')
