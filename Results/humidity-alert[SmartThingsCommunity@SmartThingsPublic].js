...
module.exports = new SmartApp()
    ...
    .subscribedEventHandler('humidityHandler', (context, event) => {
        ...
        console.log("Humidity Rose Above $tooHumid:  sending SMS and activating $mySwitch")
        ...
        console.log("Humidity Fell Below $notHumidEnough:  sending SMS and activating $mySwitch")
        this.send("${humiditySensor1.label} sensed high humidity level of ${event.value}")
        switch1?.off()
        }
        }
