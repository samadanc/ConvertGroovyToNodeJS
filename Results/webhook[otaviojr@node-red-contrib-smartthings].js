...
module.exports = new SmartApp()
    ...
    .page('mainPage', (context, page, configData) => {
        ...
        page.section('Webhook URL', section => {
            ...
            section.booleanSetting('local').name('Local Network');
        ...
        page.section('Choose what events you want to trigger', section => {
            ...
            section.deviceSetting('thermostatFanMode').capability(['thermostatFanMode']).name('Thermostat Fan Mode');
            section.deviceSetting('thermostatHeatingSetpoint').capability(['thermostatHeatingSetpoint']).name('Thermostat Heating Setpoint');
            section.deviceSetting('thermostatMode').capability(['thermostatMode']).name('Thermostat Mode');
            section.deviceSetting('thermostatOperatingState').capability(['thermostatOperatingState']).name('Thermostat Operating State');
