...
module.exports = new SmartApp()
    ...
    .page('mainPage', (context, page, configData) => {
        ...
        page.section('Turn on a fan...', section => {
            section.deviceSetting('switch1').capability(['switchLevel']).name('');

        });


        page.section('Set level to...', section => {
            section.numberSetting('fanLevel').name('Fan level?');
    ...
    .subscribedEventHandler('temperatureHandler', (context, event) => {
        ...
        console.log("Temperature rised above $tooCold:  sending SMS and activating $mySwitch")
