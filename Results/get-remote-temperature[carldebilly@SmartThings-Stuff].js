...
module.exports = new SmartApp()
    ...
    .page('mainPage', (context, page, configData) => {
        ...
        page.section('Choose the thermostats that will receive the remote device\'s temperature... ', section => {
            section.deviceSetting('thermostats').capability(['thermostat']).name('Select Thermostats');
    ...
    .subscribedEventHandler('temperatureHandler', (context, event) => {
        ...
        context.api.devices.sendCommands(context.config.thermostats, 'thermostat', quickSetOutTemp)
