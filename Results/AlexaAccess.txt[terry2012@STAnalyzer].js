...
module.exports = new SmartApp()
    ...
    .page('mainPage', (context, page, configData) => {
        ...
        page.section('Allow access to the following things...', section => {
            ...
            section.deviceSetting('colors').capability(['colorControl']).name('Which Color Lights?');
    ...
    .updated(async (context, updateData) => {
        ...
        await context.api.subscriptions.subscribeToDevices(context.config.colors, 'colorControl', 'color', 'colorHandler')
    ...
    .subscribedEventHandler('colorHandler', (context, event) => {
        ...
        let widgetId = state.widgets.color[event.displayName]
        this.notifyWidget(widgetId, ['color': event.value])
    ...
    .subscribedEventHandler('locationHandler', (context, event) => {
        ...
        for (let i : state['widgets']['mode']) {
        this.notifyWidget(i, ['mode': event.value])
        }
