...
module.exports = new SmartApp()
    ...
    .scheduledEventHandler('setClimate', (context, event) => {
        ...
        context.api.devices.sendCommands(context.config.ecobee, 'device.myEcobeeDevice', setThisTstatClimate)
    
        this.send("ecobeeSetClimate>set ecobee thermostat(s) to $climateName program as requested")
        } else {
