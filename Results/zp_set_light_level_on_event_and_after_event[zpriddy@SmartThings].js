...
module.exports = new SmartApp()
    ...
    .page('mainPage', (context, page, configData) => {
        ...
        page.section('Choose light effects...', section => {
            ...
            section.enumSetting('endColor').name('After Event Hue Color?');
            section.enumSetting('endLightLevel').name('After Event Light Level?');

        });


        page.section('Only run between sunset and sunrise?', section => {
