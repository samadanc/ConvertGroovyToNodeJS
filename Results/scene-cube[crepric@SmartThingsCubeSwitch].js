...
module.exports = new SmartApp()
    ...
    .page('mainPage', (context, page, configData) => {
        ...
        page.section('Which lights?', section => {
            section.deviceSetting('lights').capability(['colorTemperature']).name('');

        });


        page.section('Scene 1', section => {
            section.numberSetting('temp_1').name('What is the light temperature?');
        ...
        page.section('Scene 2', section => {
            section.numberSetting('temp_2').name('What is the light temperature?');
        ...
        page.section('Scene 3', section => {
            section.numberSetting('temp_3').name('What is the light temperature?');
        ...
        page.section('Scene 4', section => {
            section.numberSetting('temp_4').name('What is the light temperature?');
        ...
        page.section('Scene 5', section => {
            section.numberSetting('temp_5').name('What is the light temperature?');
        ...
        page.section('Scene 6', section => {
            section.numberSetting('temp_6').name('What is the light temperature?');
