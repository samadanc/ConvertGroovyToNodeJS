...
module.exports = new SmartApp()
    ...
    .subscribedEventHandler('motionActiveHandler', (context, event) => {
        ...
        console.log("$motion1 has moved while you were out, sending notifications to: ${recipients?.size()}")
        this.sendNotificationToContacts("${motion1.label} ${motion1.name} moved while you were out", recipients)
        } else {
        console.log("$motion1 has moved while you were out, sending text")
