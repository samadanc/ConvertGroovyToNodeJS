...
module.exports = new SmartApp()
    ...
    .subscribedEventHandler('keypadModeHandler', (context, event) => {
                ...
                if (globalFixMode) {
                    ...
                    console.log("keypadModeHandler input: ${event.value} lightMode: $theMode STalarm: $theStatus")
                }
                if (globalKeypadControl) {
                    if (theMode == 'Home' || theMode == 'Away' || theMode == 'Night' || theMode == 'Stay') {
                        ...
                        let kDtim = this.now()
                        let kMode 
                        console.log("keypadModeHandler entered $evt ${event.value} $themode $kMap")
