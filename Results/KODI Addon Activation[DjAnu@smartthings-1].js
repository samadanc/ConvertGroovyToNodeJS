...
module.exports = new SmartApp()
    ...
    .page('mainPage', (context, page, configData) => {
        ...
        page.section('Addon info', section => {
            section.textSetting('Command').name('Addon Name');

        });


        page.section('KODI Notifications LivingRoom:', section => {
        ...
        page.section('KODI Notifications Bedroom:', section => {
