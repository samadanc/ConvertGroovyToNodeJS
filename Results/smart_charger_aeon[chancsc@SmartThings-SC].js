...
module.exports = new SmartApp()
    ...
    .page('mainPage', (context, page, configData) => {
        ...
        page.section('', section => {
            section.deviceSetting('meter').capability(['switch']).name('When This Energy Outlet ...');
    ...
    .updated(async (context, updateData) => {
        ...
        await context.api.subscriptions.subscribeToDevices(context.config.meter, 'switch', 'energy', 'meterHandler')

    })

    .subscribedEventHandler('meterHandler', (context, event) => {
        
        console.log("meter.currentEnergy: ${meter.currentEnergy}")
        ...
        console.log("$meter - charging in progress. Cancelling turn off scheduler (if any).")
